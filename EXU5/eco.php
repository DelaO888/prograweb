...
<body>
    ...
    list-style-type: none;">
           ...
           <li><a class="dropdown-item" href="eco.php" style="color: white;">Economía</a></li>
            ...
            <li><a class="dropdown-item" href="orgsocail.php" style="color: white;">Organizacion Social</a></li>
          </ul>
        </div>
      </li>
  ...
  <h2 style="margin-bottom: 50px;">Economia</h2>  
...
<section class="prices">
	<div class="cards">
		...
		<ul class="features">
			...
			<p></p>
			<a class="pro-btn" href="ecomaya.php">Ver</a>
	</div>
	<div class="cards profesional-card">
		...
		<p></p>
			<a class="pro-btn" href="ecoolmecas.php">Ver</a>
	</div>
	<div class="cards">
		<div class="title-wrapper empresarial">
			<i class="fa fa-money" aria-hidden="true"></i>
			<h3 class="title">Aztecas</h3>
		</br>
		</div>
		<ul class="features">
			
		<p></p>
			<a class="pro-btn" href="ecoaztecas.php">Ver</a>	
	</div>
</section>
