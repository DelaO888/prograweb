...
<body>
  ...
  <h2 style="margin-bottom: 50px;">Cultura</h2>  
...
<section class="prices">
	<div class="cards">
		...
		<ul class="features">
			...
			<p></p>
			<a class="pro-btn" href="cultmaya.php">Ver</a>
	</div>
	<div class="cards profesional-card">
		...
		<p></p>
			<a class="pro-btn" href="cultolmeca.php">Ver</a>
	</div>
	<div class="cards">
		...
		<p></p>
			<a class="pro-btn" href="culttoto.php">Ver</a>	
	</div>
</section>
