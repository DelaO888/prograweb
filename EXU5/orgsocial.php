...
<body>
  ...
  <h2 style="margin-bottom: 50px;">Organización Social</h2>  
...
<section class="prices">
	<div class="cards">
		...
		<ul class="features">
			...
			<p></p>
			<a class="pro-btn" href="orgsocmayas.php">Ver</a>
	</div>
	<div class="cards profesional-card">
		...
		<p></p>
			<a class="pro-btn" href="orgsocolmecas.php">Ver</a>
	</div>
	<div class="cards">
		...
		<p></p>
			<a class="pro-btn" href="orgsocaztecas.php">Ver</a>	
	</div>
</section>
