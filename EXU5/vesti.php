...
<body>
  ...
  <h2 style="margin-bottom: 50px;">Vestimenta</h2>  
...
<section class="prices">
	<div class="cards">
		...
		<ul class="features">
			...
			<p></p>
			<a class="pro-btn" href="vestimayas.php">Ver</a>
	</div>
	<div class="cards profesional-card">
		...
		<p></p>
			<a class="pro-btn" href="vestiolmecas.php">Ver</a>
	</div>
	<div class="cards">
		...
		<p></p>
			<a class="pro-btn" href="vestiaztecas.php">Ver</a>	
	</div>
</section>
